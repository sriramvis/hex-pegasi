...
import com.hexforhn.hex.util.VolleyUtil;

import static android.text.TextUtils.*;

/**
 * Created by sriram on 4/12/16.
 */
public class OrionNativeAdview extends FrameLayout {
    ...
    public void initAdView(INativeAd ad) {
        ...
        if (iconUrl != null) {
            com.hexforhn.hex.util.VolleyUtil.loadImage(iconImageView, iconUrl);
        }
        //获取大卡的背景图片的url
        String mainImageUrl = ad.getAdCoverImageUrl();
        if (!isEmpty(mainImageUrl)) {
